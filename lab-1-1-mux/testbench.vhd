...
begin
  ...
  begin
    ...
    D0_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D0" severity error;
    D0_in <= '0';
    ...
    D1_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D1" severity error;
    D1_in <= '0';
    ...
    D2_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D2" severity error;
    D2_in <= '0';
    ...
    D3_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D3" severity error;
    D3_in <= '0';
    ...
    D4_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D4" severity error;
    D4_in <= '0';
    ...
    D5_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D5" severity error;
    D5_in <= '0';
    ...
    D6_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D6" severity error;
    D6_in <= '0';
    ...
    D7_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D7" severity error;
    D7_in <= '0';
    ...
    D8_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D8" severity error;
    D8_in <= '0';
    ...
    D9_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D9" severity error;
    D9_in <= '0';
    ...
    D10_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D10" severity error;
    D10_in <= '0';
    ...
    D11_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D11" severity error;
    D11_in <= '0';
    ...
    D12_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D12" severity error;
    D12_in <= '0';
    ...
    D13_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D13" severity error;
    D13_in <= '0';
    ...
    D14_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D14" severity error;
    D14_in <= '0';
    ...
    D15_in <= '1';
    wait for 1 ns;
    assert(Y_out='1') report "Fail: Select D15" severity error;
    D15_in <= '0';
